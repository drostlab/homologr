#' @title Perform a DIAMOND best hit search
...
#' @seealso \code{\link{diamond_reciprocal_best_hits}}, \code{\link[rdiamond]{diamond_protein_to_protein}}
#' @export

diamond_best_hits <- function(
                       query,
                       subject,
                       is_subject_db = FALSE,
                       format          = "fasta",
